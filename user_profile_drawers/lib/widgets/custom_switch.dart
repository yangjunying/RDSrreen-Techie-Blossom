...
class CustomSwitch extends StatefulWidget {
  ...
  final Color activeThumbColor, inactivThumbColor;
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          border: Border.all(
              color:
                  value ? widget.activeBorderColor : widget.inactiveBorderColor,
            ...
            AnimatedPositioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(4),
                  color: value ? widget.activeThumbColor : widget.inactivThumbColor,
                ),
              ),
            ),
            Positioned(
              ...
              child: Center(
                child: AnimatedOpacity(
                  duration: widget.duration,
                  opacity: value ? 1 : 0,
                  child: Text(widget.activeText, style: widget.activeTextStyle),
                ),
              ),
            ),
            Positioned(
